...
public class addActivity extends AppCompatActivity {
    ...
    public void save(View view){
        ...
        database.contactDAO().insert(new Contact(firstName.getText().toString(),lastName.getText().toString(),job.getText().toString(),phone.getText().toString(), email.getText().toString()));
        Intent myIntent = new Intent(addActivity.this, MainActivity.class);
        startActivity(myIntent);
    }
