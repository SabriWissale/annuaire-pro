...
public class MainActivity extends AppCompatActivity implements ContactsAdapter.SelectedContact{
    ...
    Contact contact1=new Contact("Wissale","Sabri","Ingénieur d'état","0678119921","sabri@gmail.com");
    Contact contact2=new Contact("Basma","Sabri","Professeur","0610969037","basma@gmail.com");
    Contact contact3=new Contact("Tata","Fatima","Directrice d'école primaire","0625867047","fatti@gmail.com");
    Contact contact4=new Contact("Sara","ihdabbou","CEO","0612345678","ihdabbou@gmail.com");
    @Override
