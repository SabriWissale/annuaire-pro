...
public class EditActivity extends AppCompatActivity {
    ...
    public void save(View view){
        ...
        database.contactDAO().update(new Contact(Integer.parseInt(string),firstName.getText().toString(),lastName.getText().toString(),job.getText().toString(), phone.getText().toString(), email.getText().toString()));
